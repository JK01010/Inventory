 ...
 */
@interface HSMDecodeResult : NSObject
 ...
 */
@property (assign) BarcodeBounds* bounds;
...
/**
 * @brief This property contains  Array of ocr data of Type .OCRResult
 */
@property (retain) NSArray* ocrResults;

/**
 * @brief This property contains the corrected bounds
 */
@property (assign) BarcodeBounds* correctedBounds;
