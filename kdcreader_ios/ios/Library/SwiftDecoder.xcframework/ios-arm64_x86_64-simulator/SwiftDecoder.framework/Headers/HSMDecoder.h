 ...
 *
 * @param userTemplate
 *  The OCR template used in USER mode
 *
 * @return
 *  Boolean The success of the operation
 */
- (Boolean) setOCRUserTemplate:(char*)userTemplate;
/**
 ...
 * @param templateOCRFileData encrypted  data stored in QR barcode
 * @return
 ...
 */
-(int)addOCRTemplate:(NSData*)templateOCRFileData;

-(int)addScannedOCRTemplate:(HSMDecodeResult*)decodeResult;
/**
