...
// import '../../domain/use_cases/transaction_usecase/filter_transaction_list_usecase.dart';
// import '../../domain/use_cases/transaction_usecase/get_all_goods_receipt_transaction_use_case.dart';
// import '../../domain/use_cases/transaction_usecase/get_all_grn_transaction_item_use_case.dart';
// import '../../domain/use_cases/transaction_usecase/sync_transaction_list_usecase.dart';

// part 'goods_receipts_transaction_event.dart';

// part 'goods_receipts_transaction_state.dart';

// class GoodsReceiptsTransactionBloc
//     extends Bloc<GoodsReceiptsTransactionEvent, GoodsReceiptsTransactionState> {
//   GoodsReceiptsTransactionBloc({
...
//   }) : super(GoodsReceiptsTransactionState.initial()) {
//     on<GoodsReceiptsTransactionEvent>((event, emit) async {
//       switch (event) {
...
//     Emitter<GoodsReceiptsTransactionState> emit,
//   ) async {
...
//         //       groupedByPoID[item.poNo]!.add(item);
//         //     } else {
//         //       groupedByPoID[item.poNo] = [item];
...
//         emit(
//           state.copyWith(transactionEntity: transactionList, isLoading: true),
//         );
//       },
//     );
...
//         state.transactionEntity.where((element) => !element.syncStatus).toSet();
//     emit(state.copyWith(syncList: transactionList));
//   }

//   bool isSelectAll() {
//     if (state.syncList.isEmpty || state.transactionEntity.isEmpty) {
//       return false;
//     }
//     final unSyncedList =
...
//       emit(state.copyWith(transactionEntity: transactionEntity));
//     });
//   }
...
//         emit(
//           state.copyWith(
//             transactionEntity: transactionEntityList,
