...
class CustomTypeAheadFieldEquipment<T> extends StatelessWidget {

  const CustomTypeAheadFieldEquipment({
    super.key,
    required this.label,
    required this.hint,
    ...
    return BlocBuilder<ConsumptionItemUpdateBloc, ConsumptionItemUpdateState>(
      builder: (context, state) {
        return TextFormField(
          onChanged: (value) {
            return context.read<ConsumptionItemUpdateBloc>().add(EquipmentListSearchEvent(searchText:value));
          },
