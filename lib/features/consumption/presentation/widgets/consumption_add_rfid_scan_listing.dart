...
class ConsumptionAddRfidScanListing extends StatelessWidget {
  ConsumptionAddRfidScanListing({
    super.key,
  ...
  final ValueNotifier<bool> consumptionSelected = ValueNotifier(false);
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                          ...
                          >(
                            builder: (context, state) {
                              return RoundedCheckBoxWidget(
                                value:
                                    state.viewList[index].isSelected ?? false,
                                onTap: () {
                                  bool value =
                                      state.viewList[index].isSelected ?? false;
                                  context
                ...
                Visibility(
                  //Storage location
                  visible: itemList.ihm == 1, //todo change to isEquipment check
                  replacement: Column(
                    children: [
                      SizedBox(height: AppSize.size10),
                      SingleHeadingText(title: context.l.remarks, value: "-"),
                    ],
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
