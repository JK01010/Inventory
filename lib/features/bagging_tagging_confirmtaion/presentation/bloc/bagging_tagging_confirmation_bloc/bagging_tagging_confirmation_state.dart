...
class BaggingTaggingConfirmationState extends Equatable {
  const BaggingTaggingConfirmationState({
  ...
  factory BaggingTaggingConfirmationState.initial() =>
  ...
  BaggingTaggingConfirmationState copyWith({
    bool? isLoading,
    ...
    return BaggingTaggingConfirmationState(
