...
class ItemMasterListShimmer extends StatelessWidget {
  const ItemMasterListShimmer({super.key});
  ...
  Widget build(BuildContext context) {
    return AppDecoratedBoxShadowWidget(
      child: Shimmer.fromColors(
        baseColor:
        context.isDarkMode? AppColor.colorDarkProfileContainer:AppColor.colorBlack6,
