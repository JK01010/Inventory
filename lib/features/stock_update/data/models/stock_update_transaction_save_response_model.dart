...
class StockUpdateTransactionSaveResponseModel extends Equatable {
  const StockUpdateTransactionSaveResponseModel({
    required this.status,
    required this.statusMsg,
    required this.transactionHD,
  });

  factory StockUpdateTransactionSaveResponseModel.fromJson(Map<String, dynamic> map) {
    return StockUpdateTransactionSaveResponseModel(
      status: map['status'] ?? '',
      statusMsg: map['statusMsg'] ?? '',
      transactionHD: map['transactionHD'] == null
          ? []
          : List<TransactionHdModel>.from(
