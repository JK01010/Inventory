...
class StockUpdateTransactionSaveRequestModel extends Equatable {
  const StockUpdateTransactionSaveRequestModel({
    this.grnID,
  ...
  factory StockUpdateTransactionSaveRequestModel.fromJson(Map<String, dynamic> map) {
    return StockUpdateTransactionSaveRequestModel(
      grnID: map['grnID'],
